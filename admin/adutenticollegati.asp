...
<html lang="en">
	...
	'SQL
	Grid.SQL = "select id  as idinc,id,ragione,indirizzo,citta,provincia,utente,password,nome,cognome,email,telefono,data,tipo from utenticollegati order by id desc "
	...
	' stat prodotti
	Grid.Cols("Idinc").AttachExpression "<A class=navy11 HREF=""adutentistat.asp?psw={{password}}""><img src=images/account.gif border=0></A>"

	
	' Find a record if a search criteria is set
	Criteria = Request("CRITERIA")
	If Criteria <> "" Then
	  Grid.Find "password like '" & TRIM(Criteria) & "'"
	End If
