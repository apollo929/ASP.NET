...
<html lang="en">
    ...
    <body>
        <div id="wrapper">
            ...
            <form action="adutentiprodettaglio.asp?act=1&id=<%=request("id")%>&mod=<%=request("mod")%>" method="post" id=formuu name=formuu>
					...
					<OPTION VALUE="PREZZO1">PREZZO1 (prezzi listino & quantita')</OPTION>
					</SELECT></b></td>
					</tr>
					<tr>
					<td ><b>Prezzo LISTINI PARTICOLARI </b><font color="#FF0000">*</font></td>
					...
					<OPTION VALUE="NESSUNOLISTINO">NESSUNOLISTINO</OPTION>
					</SELECT></td>
					</tr>					
					<tr>
					<td >Nome Agente</td>
					...
					<form action="adutentiprodettaglio.asp?id=<%=request("id")%>&del=<%=request("id")%>" method="post" id=formd name=formd>
