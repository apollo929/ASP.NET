...
if request("del")<>"" then
	...
	response.Redirect "adutentinternet.asp"
end if
...
<td valign=top width=550 height=100% bgcolor='moccasin'>
            ...
            <form action="dettaglioint.asp?act=1&id=<%=request("id")%>&mod=<%=request("mod")%>" method="post" id=formuu name=formuu>
					...
					<td ><a href=adutentinternet.asp? ><img src='images/senzamodifiche.gif' border=0 ></a></td>
					</tr>
				  	</table>	  
