...
<%=editorid%> .CuteEditorGroupMenu {margin:1px;float: left;background-image: url(Images/horizontal.background.gif); background-repeat: repeat-x; height:27px; vertical-align:middle;border-top:1px solid #A6B6C5;border:1px solid #A6B6C5;}
