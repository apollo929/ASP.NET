...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">		
			var OxO8a0e=["width","style","idSource","100%","height"];if(!Browser_IsSafari()){ document.getElementById(OxO8a0e[0x2])[OxO8a0e[0x1]][OxO8a0e[0x0]]=OxO8a0e[0x3] ; document.getElementById(OxO8a0e[0x2])[OxO8a0e[0x1]][OxO8a0e[0x4]]=OxO8a0e[0x3] ;} ;
	</script>
