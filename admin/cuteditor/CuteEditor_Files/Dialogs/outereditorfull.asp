...
override protected void OnInit(EventArgs args)
{
	...
	{
		string FrameSrc="OuterEditorFull.asp?IsFrame=1&"+Request.ServerVariables["QUERY_STRING"];
		CuteEditor.CEU.WriteDialogOuterFrame(Context,"<%= GetString("NewTemplate") %>",FrameSrc);
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<![endif]-->
		<title><%= GetString("NewTemplate") %></title>
	</head>
	<body bgcolor="white">
		<form id="Form1">
			<CE:EDITOR 
