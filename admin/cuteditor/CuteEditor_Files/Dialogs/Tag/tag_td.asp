...
<fieldset>
        <legend><%= GetString("EditCell") %></legend>
				<table class="normal" cellpadding="2" cellspacing="1" width="98%">
					...
					<tr>
						<td width="100"><%= GetString("BorderColorLight") %>:</td>
						<td>
					...
					<tr>
						<td><%= GetString("noWrap") %>:</td>
						<td>
							 <select id="sel_noWrap" style="width:90px">
								<option value=""><%= GetString("Default") %></option>
								<option value="noWrap"><%= GetString("noWrap") %></option>
							</select>	
						</td>
						<td></td>
						<td><%= GetString("CellScope") %>:</td>
						<td>
