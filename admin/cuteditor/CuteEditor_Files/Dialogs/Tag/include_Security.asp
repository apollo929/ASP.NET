<%
   ...
   dim q_CESecurity
   dim ResourceDir
   s_CESecurity=Trim(Request.Cookies("CESecurity"))
   ...
   if CESecurity <> "" Then
        ...
        ResourceDir=CESecurityArray(19)
   Else
        Response.Write "The area you are attempting to access is forbidden"	
	    Response.End        
   End if 
   ...
   ResourceDir = Left(request.ServerVariables("PATH_INFO"),InStr(request.ServerVariables("PATH_INFO"),ResourceDir)+len(ResourceDir)-1)
...
<script type="text/javascript">
    var OxOedeb=[];var isDemoMode=false;
</script>