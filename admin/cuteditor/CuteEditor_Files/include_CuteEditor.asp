...
Class CuteEditor
	...
	Public Property Let UseNetSpell(yesornot)
		s_UseNetSpell= Lcase(CStr(yesornot))
	End Property			
	...
	private Function BuildBottomBar()
		...
		if (s_showBottomBar) then
			...
			strTemp = strTemp & "<img title="""&G_Str("Normal")&""" Command=""TabEdit""  src="""&ProcessThemeWebPath("design.gif")&""" border=""0"" />"
			if s_showhtmlmode = "true" then
				strTemp = strTemp & "<img title="""&G_Str("HTML")&""" Command=""TabCode""  src="""&ProcessThemeWebPath("htmlview.gif")&""" border=""0"" />"
			end if
			if s_showpreviewmode = "true" then
				strTemp = strTemp & "<img title="""&G_Str("Preview")&""" Command=""TabView""  src="""&ProcessThemeWebPath("preview.gif")&""" border=""0"" />"
			end if
			strTemp = strTemp & "</td>"
			...
			if s_ShowWordCount= "true" then
			    strTemp = strTemp & "<td align='right' style='text-align:right;' nowrap='nowrap'><span class='WordCount'></span><span class='WordSpliter'>&nbsp;</span><span class='CharCount'></span></td>"
			end if
			strTemp = strTemp & "<td align='right'>"
			if Lcase(s_ResizeMode) = "plusminus" then
			    if s_ShowEnlargeButton then
				    strTemp = strTemp & "<img title="""&G_Str("Enlarge")&""" Command=""sizeplus"" src="""&ProcessThemeWebPath("plus.gif")&""" border=""0""/>"
			    end if
			    if s_ShowDecreaseButton then
				    strTemp = strTemp & "<img title="""&G_Str("Decrease")&""" Command=""sizeminus"" src="""&ProcessThemeWebPath("minus.gif")&""" border=""0""/>"
			    end if
			elseif Lcase(s_ResizeMode) = "resizecorner" then
				    strTemp = strTemp & "<img title="""&G_Str("Resize")&""" ondragstart=""return false"" onmouseover=""(CuteEditor_GetEditor(this).RegisterResizeCornor||function(){})(this.parentNode)"" src="""&GetURL("Images/ResizeCorner.gif")&""" border=""0""/>"
			end if 
			strTemp = strTemp & "</td>"
	...
	private Function editorClientScript ()
		...
		if s_subsequent = "false" then 
			strTemp = "<script language=""JavaScript"" SRC="""&s_filespath&"/Scripts/spell.js""></script><script language=""JavaScript"" SRC="""&s_filespath&"/Scripts/Constant.js""></script><script language=""JavaScript"" SRC="""&s_filespath&"/license/CuteEditorLic.js""></script>"
		end if
	...
	Public Function GetString()
		...
		Else	
			strTemp = strTemp & " <!-- CuteEditor Version 6.1 "&ID&" Begin --> " & vbCRLF
			...
			strTemp = strTemp & "<table "&s&" id="""&ClientID&""" _IsCuteEditor=""True"" cellspacing=""0"" cellpadding=""0"" height="&s_height&" width="&s_width&" style=""background-color:"&s_BackColor&";border-color:"&s_BorderColor&";border-width:"&s_BorderWidth&"px;border-style:"&s_BorderStyle&";table-layout:auto;height:"&s_height&";width:"&s_width&";"">"
	...
	Public function GetToolbarFromItemList(templatelist,d_list)
		...
		If	BrowserType="Gecko" or BrowserType="Opera" then
			d_list = d_list & ",zoom"
		end if
	...
	private Property Get AddToolbarForeColor
	    ...
	    AddToolbarForeColor = "<img id='"&c&"' Command=""ForeColor"" title="""&G_Str("ForeColor")&""" src='"&ProcessThemeWebPath("fontcolor.gif")&"' width='17' height='20' border=0 style='background-color: red;' "&t&"/>"
	    t=""	    
		if s_ReadOnly <> "true" then
		    if Lcase(BrowserType) = "safari12" then
	    ...
	    AddToolbarForeColor = AddToolbarForeColor & "<img Command=""SetForeColor"" title="""&G_Str("SetForeColor")&""" src='"&ProcessThemeWebPath("tbdown.gif")&"' width='9' height='20' border='0' "&t&"/>"	    
	End Property		
	private Property Get AddToolbarBackColor
	    ...
	    AddToolbarBackColor = "<img id='"&c&"' Command=""BackColor"" title="""&G_Str("BackColor")&""" src='"&ProcessThemeWebPath("colorpen.gif")&"' width='17' height='20' border=0 style='background-color: yellow;' "&t&"/>"
	    t=""	    
		if s_ReadOnly <> "true" then
		    if Lcase(BrowserType) = "safari12" then
	    ...
	    AddToolbarBackColor = AddToolbarBackColor & "<img Command=""SetBackColor"" title="""&G_Str("SetBackColor")&""" src='"&ProcessThemeWebPath("tbdown.gif")&"' width='9' height='20' border='0' "&t&"/>"	    
	End Property		
	private Property Get AddToolbarTable
	    ...
	    AddToolbarTable = "<img Command=""TableDropDown"" title="""&G_Str("TableDropDown")&""" src='"&ProcessThemeWebPath("instable.gif")&"' "&t&"/>"
	End Property	
