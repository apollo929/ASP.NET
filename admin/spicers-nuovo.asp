...
<html>
<head>
<title>INSERISCI ARTICOLI SPICERS</title>
...
window.location='http://www.pokersrl.com/admin/spicers-nuovo.asp?cat='+optVal;
}
</SCRIPT>
</head>
...
<!-- #include file=_menu.inc --->
	...
	<table width="100%">
		<form action="spicers-nuovo-ins.asp" method="post" id="form1" name="form1">
		...
		<tr>
			<td>Codice spicers:</td>
			<td><input type="text" name="cod_sp" value=""></td>
		</tr>
		<tr>
		...
		<tr>
			<td>Prezzo 5:</td>
			<td><input type="text" name="p5" value=""></td>
		</tr>
		...
		<tr>
			<td>Giacenza:</td>
			<td><input type="text" name="giacenza" value=""></td>
		</tr>
