...
<%' 
	...
	'SQL
	Grid.SQL = "Select * From Modello_Disp Order by Id desc"
	...
	' Set Colors
	Grid.ColRange(1,8).Header.BGColor = "#B0B0FF"
	Grid.ColRange(1,8).Header.Font.Face = "Verdana"
	Grid.ColRange(1,8).Cell.Font.Face = "Verdana"
	Grid.ColRange(2,8).InputSize=15
