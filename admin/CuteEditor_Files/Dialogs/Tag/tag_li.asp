...
<table width="85%" align=center cellpadding="1" cellspacing="2" id="tag-list">
	...
	<td nowrap colspan="5" style="padding-top:5">
		<span style="width:90"><%= GetString("StartingNumber") %></span>: <input onkeypress="return CancelEventIfNotDigit()" id="inp_start" type="text" name="inp_start" value="1" size="3">
	</td>
	</tr>
	<tr>
	<td colspan="5">		
		<input type="checkbox" id="inp_checked" onclick="ToggleCustomBullet();" /><%= GetString("CustomBullet") %>
		<br />
		<div id="CustomBullet">
			<%= GetString("Image") %>:
