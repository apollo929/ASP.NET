...
var OxO3b33=["ondblclick","navtd","shiftKey","style"]; Window_GetElement(window,OxO3b33[0x1],true)[OxO3b33[0x0]]=function (){if(event[OxO3b33[0x2]]){ alert(element[OxO3b33[0x3]].cssText) ;} ;}  ;
</script>