        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
						...
						<h2 class="related-products-title">Carta Buffetti  </h2>
			...
			<%
										...
										'Query
										querydcount="Select count(*) as Tot From prodotti where codice_buf like '0049%' and fornitore like '%buffetti%'"
										...
										querydp="Select * From prodotti where codice_buf like '0049%' and fornitore like '%buffetti%' order by p1 asc "
