				...
				<%if preview=true then%>
					<tr>
						<td class=bianco10 align=middle colspan=2>
							...
							<br><br>
							<%if txt_id=1 then %>
							  <a class=orangesp href="javascript:putimmagine('<%=request("file")%>')"><img src="img/frecciaaccetta.jpg" border=0><u><b>Accetta</b></u></a>
							<%end if%>  
							<%if txt_id=2 then %>
							  <a class=orangesp href="javascript:putimmagine1('<%=request("file")%>')"><u><b>&nbsp;&nbsp;&nbsp;&nbsp;Accetta</b></u></a>
							<%end if%> 
							<%if txt_id=3 then %>
							  <a class=orangesp href="javascript:putimmagine2('<%=request("file")%>')"><u><b>&nbsp;&nbsp;&nbsp;&nbsp;Accetta</b></u></a>
							<%end if%>  
							<%if txt_id=4 then %>
							  <a class=orangesp href="javascript:putimmagine3('<%=request("file")%>')"><u><b>&nbsp;&nbsp;&nbsp;&nbsp;Accetta</b></u></a>
							<%end if%>  
							<%if txt_id=5 then %>
							  <a class=orangesp href="javascript:putimmagine4('<%=request("file")%>')"><u><b>&nbsp;&nbsp;&nbsp;&nbsp;Accetta</b></u></a>
							<%end if%>  							
						</td>
					</tr>
				<%else%>
					<tr>
						<td class=bianco10 align=middle colspan=2>
							 <u>Avvertenze</u>
							<p align=justify>Il programma gestisce esclusivamente immagini con dimensioni 100x100pixels. E' comunque possibile inserire immagini con dimensioni superiori purchè non superino la dimensione di 20KBytes. Sarà vostra cura mantenere le proporzioni dell'immagine altrimenti verrà distorta come da esempio qui in basso!</p>
							</font>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class=bianco10 align=middle>
							 <u>Dopo</u><br><br></font>
							<img src=imgdemo.jpg width=100 height=100>
						</td>
					</tr>
				<%end if%>
			</table>
