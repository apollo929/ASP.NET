...
if Trim(text_azienda)="" then	
  testoemail=Ucase("Cartadicredito_" & Replace(Replace(Replace(Trim(text_cognome),".","_"),",","_"),"&","-"))
else
  testoemail=Ucase("Cartadicredito_" & Replace(Replace(Replace(Trim(text_azienda),".","_"),",","_"),"&","-"))
end if 	
'RIFERIMENTO A PAYPAL
NHTM = NHTM & "<b>ATTENDERE PAGAMENTO SUL WEB PAYPAL PRIMA DI CONSEGNARE MERCE</b><br><br>"
...
response.redirect "cartadicredito.asp?sped=ok&nordine=" & numeroordine
%>
