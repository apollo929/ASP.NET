...
HTML = HTML & " Spese di Spedizione Addebitate Euro " & Formatnumber(Session("CostoSpese"),2) & "<br>RITIRO : <b>IN NEGOZIO</b><br>"
...
NHTM = NHTM & " Spese di Spedizione Addebitate Euro " & Formatnumber(Session("CostoSpese"),2) & "<br>RITIRO : <b>IN NEGOZIO</b><br>"
...
if Trim(text_azienda)="" then	
  testoemail=Ucase("PagainNegozio_" & Replace(Replace(Replace(Trim(text_cognome),".","_"),",","_"),"&","-"))
else
  testoemail=Ucase("PagainNegozio_" & Replace(Replace(Replace(Trim(text_azienda),".","_"),",","_"),"&","-"))
end if 	
