...
<input type="text" style="height:45px;width:316px;" id="termscartucce" name="termscartucce"  placeholder="cod. modello stampante & cartuccia " ><input type="submit" style="height:45px;" value="Search">
</form>	
<br><br>
</center>
