                                ...
                                <div class="panel-group" id="accordion">
                                    <div class="panel panel-default">
                                            ...
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne1">DB TIPO DOCUMENTI</a>
                                            </h4>
                                        </div>
                                        <div id="collapseOne1" class="panel-collapse collapse in">
                                            <div class="panel-body">							
												...
												<%
													...
													Grid.SQL=""
													Grid.SQL = "select * from tipodocumenti"
													...
													Grid.Cols("iddoc").readonly = True
													Grid.Cols("iddoc").hidden=True
												    Grid.Cols("iddoc").Caption="&nbsp;"
													'Grid.Cols("email").Caption="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;__________email________&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
