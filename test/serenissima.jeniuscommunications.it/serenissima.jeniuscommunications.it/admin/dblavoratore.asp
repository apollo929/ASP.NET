                                ...
                                <div class="panel-group" id="accordion">
                                    <div class="panel panel-default">
                                            ...
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne1">DB TIPO LAVORATORE</a>
                                            </h4>
                                        </div>
                                        <div id="collapseOne1" class="panel-collapse collapse in">
                                            <div class="panel-body">							
												...
												<%
													...
													Grid.SQL=""
													Grid.SQL = "select * from tipolavoratore"
													...
													Grid.ColRange(3,5).Cell.Align = "center"														
													' Set Colors
													Grid.ColRange(1,4).Header.BGColor = "#f6f6f6"
													Grid.ColRange(1,4).Header.Font.Face = "sans-serif"
													Grid.ColRange(1,4).Cell.Font.Face = "sans-serif"
