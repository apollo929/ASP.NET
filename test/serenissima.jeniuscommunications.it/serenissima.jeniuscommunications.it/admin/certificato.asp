 ...
 <div id="wrapper">
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                Dati Preventivo <button type="button" class="btn btn-lg btn-danger"><b>n° <%=intid%></b></button>
                            </div>
                            <!-- /.panel-heading -->
        ...
        <!-- /#wrapper -->
			<%if verifica_acquisto.eof then%>
				...
				<div>
			<%else%>
				<form action="richiestariaddebito.asp?cm=rid" method="post" id="formria" name="formria">
				<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label form-input-icon">
				<i class="fa fa-envelope-o"></i>
				<label class="mdl-textfield__label" for="register-email">descrivere motivazione riaddebito contatto</label><br>
				<input type="text" name="motivazione" class="form-control" placeholder="descrizione.....">
				<input type="hidden" name="idprev" class="form-control" value="<%=intid%>">
				<input type="hidden" name="id" class="form-control" value="<%=session("loginid")%>">
				<br><br>
				<!-- Provides extra visual weight and identifies the primary action in a set of buttons -->
				<button type="submit" class="btn btn-primary">RICHIEDO RIADDEBITO CONTATTO</button>												
				</div>
				</form>	
			<%end if%>	
