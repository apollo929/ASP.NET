...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title><%= GetString("PasteWord") %></title>		
	...
	<body>
		<div id="ajaxdiv">
			<table border="0" cellpadding="0" cellspacing="2">
				<tr>
					<td style="padding:4px;"><%= GetString("UseCtrl_VtoPaste") %></td>
				</tr>
				<tr>
					<td>
						<div id="divouter">
						<iframe id="idSource" name="idSource" src="../Template.asp" scrolling="auto" frameborder="0"></iframe>
						</div>
					</td>
				</tr>
			</table>
