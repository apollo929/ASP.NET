...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title><%= GetString("InsertChars") %> </title>
		...
		<div id="ajaxdiv">
			<table border="0" cellspacing="2" cellpadding="2" width="98%">
				<tr>
					<td class="normal">
						<%= GetString("FontName") %>: 
						<input type="radio" onpropertychange="sel_font_change()" id="selfont1" name="selfont" value="" checked="checked"  /><label for="selfont1"><%= GetString("Default") %></label> 
