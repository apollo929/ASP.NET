...
override protected void OnInit(EventArgs args)
{
	...
	{
		string FrameSrc="Thumbnail.asp?IsFrame=1&"+Request.ServerVariables["QUERY_STRING"];
		CuteEditor.CEU.WriteDialogOuterFrame(Context,"<%= GetString("AutoThumbnail") %>",FrameSrc);
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="margin:0px;border-width:0px;padding:4px;">
							...
							<fieldset style="height:80px;">
								<table border="0" cellpadding="1" cellspacing="0" class="normal">
									<tr>
										...
										<td rowspan="2" align="right" valign="middle"><img src="../Images/locked.gif" id="imgLock" width="25" height="32" title="<%= GetString("ConstrainProportions") %>" /></td>
									</tr>
									<tr>
					...
					<tr>
						<td>
							<div style="margin-top:8px;text-align:center">
								<asp:Button id="okButton" Text="  <%= GetString("OK") %>  " OnClick="thumbnailButton_Click" />
								&nbsp;&nbsp;
								<input type="button" value="<%= GetString("Cancel") %>" onclick="top.returnValue=false;top.close()" />
							</div>
						</td>
					</tr>				
				</table>
		...
		<script type="text/javascript">
			...
			var defaultwidth = <%= secset.ThumbnailWidth %>;
			var defaultheight = <%= secset.ThumbnailHeight %>;
