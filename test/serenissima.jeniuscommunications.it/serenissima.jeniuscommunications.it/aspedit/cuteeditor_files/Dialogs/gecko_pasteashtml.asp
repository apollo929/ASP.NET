...
<body>
    <div id="ajaxdiv">
        <table border="0" cellpadding="0" cellspacing="2" width="100%" id="Table1">
            <tr>
                <td style="padding:4px;">
                    <%= GetString("UseCtrl_VtoPaste") %>
                </td>
            </tr>
            <tr>
                <td>
                    <div id="divouter">
                        <iframe id="idSource" name="idSource" src="../Template.asp" scrolling="auto" frameborder="0">
                        </iframe>
                    </div>
                </td>
            </tr>
        ...
        <br />
        <div align="center">
            <input type="button" id="Button2" name="insert" class="formbutton" value="<%= GetString("Insert") %>"
