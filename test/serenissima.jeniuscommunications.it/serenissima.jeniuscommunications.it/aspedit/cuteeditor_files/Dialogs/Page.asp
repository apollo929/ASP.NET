						...
						<table border="0" cellpadding="3" cellspacing="0" style="border-collapse:collapse;" class="normal"
							...
							<tr>
								...
								<td>
									...
									<img alt="" id="bgcolor_Preview" src="../Images/colorpicker.gif" class="cursor" style="margin-bottom:-2px" />
								</td>
								<td style="width:5"></td>
								<td><%= GetString("ForeColor") %>:</td>
								<td>
									<input autocomplete="off" type="text" id="fontcolor" name="fontcolor" size="7" />
								    <img alt="" src="../Images/colorpicker.gif" id="fontcolor_Preview" class="cursor" style="margin-bottom:-2px" />
								</td>
							</tr>
							<tr>
                            ...
                            <tr>
                                <td>
                                    <%= GetString("MarginWidth") %>:</td>
                                <td>
                                    <input type="text" id="MarginWidth" name="MarginWidth" size="7" style="width: 57px"
                                        onkeypress="return CancelEventIfNotDigit()" />
                                    Pixels
                                </td>
                                <td style="width: 5px">
