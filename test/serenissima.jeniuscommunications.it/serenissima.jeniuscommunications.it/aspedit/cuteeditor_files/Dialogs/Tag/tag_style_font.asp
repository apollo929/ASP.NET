...
<div id="div_font_detail">
	<fieldset style="padding:4px;"><legend><%= GetString("FontFamily") %></legend>		
		<select id="sel_fontfamily" style="width:240px" NAME="sel_fontfamily">
			<option value=""><%= GetString("NotSet") %></option>
	...
	<fieldset style="padding:4px;"><legend><%= GetString("Decoration") %></legend>
	...
	<fieldset style="padding:4px;"><legend><%= GetString("Style") %></legend>
	...
	<fieldset style="padding:4px;"><legend><%= GetString("Size") %></legend>
	...
	<fieldset style="padding:4px;"><legend><%= GetString("Color") %></legend>	
				<input autocomplete="off" size="7" type="text" id="inp_color" style="width:57px;vertical-align:top"/>
