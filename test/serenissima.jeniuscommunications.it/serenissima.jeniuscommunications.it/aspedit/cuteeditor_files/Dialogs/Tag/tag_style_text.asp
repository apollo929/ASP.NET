...
<fieldset style="padding:4px;"><legend><%= GetString("Alignment") %></legend>
...
<fieldset style="padding:4px;"><legend><%= GetString("TextFlow") %></legend>
	<table border="0" cellspacing="0" cellpadding="2" class="normal">
		<tr>
			<td style="width:80px"><%= GetString("Indentation") %>:
			</td>
