...
<fieldset style="padding: 3px;"><legend><%= GetString("Backgroundcolor") %></legend>
	<div style="padding:3px;">
	    ...
	    <img alt="" src="../images/colorpicker.gif" id="inp_color_Preview" class="cursor" style="margin-bottom:-2px" />
	</div>
</fieldset>
<fieldset style="padding: 3px;"><legend><%= GetString("Backgroundimage") %></legend>
	...
	<div style="padding-left: 32px;">
		<table border="0" cellpadding="2" cellspacing="0" class="normal">
			<tr>
				<td style="width:80px"><%= GetString("Tiling") %>: </td>
	...
	<fieldset style="padding:4px;"><legend><%= GetString("Position") %></legend>
		<table border="0" cellpadding="2" cellspacing="0" class="normal">
			<tr>
