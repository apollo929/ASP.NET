...
<fieldset style="padding:4px;"><legend><%= GetString("Input") %></legend>
	<table class="normal">
		<tr>
	...
	<table class="normal">
		...
		<tr>
			...
			<img alt="" id="inp_item_forecolor_Preview" src="../Images/colorpicker.gif" class="cursor" style="margin-bottom:-2px" />
			</td>
			<td><%= GetString("BackColor") %>:&nbsp;<input autocomplete="off" size="7" type="text" id="inp_item_backcolor" />
			<img alt="" id="inp_item_backcolor_Preview" src="../Images/colorpicker.gif" class="cursor" style="margin-bottom:-2px" />
			</td>
		</tr>
	</table>
</fieldset>
