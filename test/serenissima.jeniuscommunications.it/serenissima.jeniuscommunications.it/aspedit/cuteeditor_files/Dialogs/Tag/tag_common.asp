...
<img alt="" src="../images/colorpicker.gif" id="img_forecolor" class="cursor" style="margin-bottom:-2px" />
				</td>
			</tr>
			<tr>
...
<img alt="" src="../images/colorpicker.gif" id="img_backcolor" class="cursor" style="margin-bottom:-2px" />
				</td>
			</tr>
			<tr>		
