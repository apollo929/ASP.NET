				...
				<tr>
							...
							<table id="tblBorderStyle" cellpadding="5" cellspacing="0" width="100%" style="table-layout:fixed;background:white">
								<tr>
									<td valign="top" onmouseover="CuteEditor_ColorPicker_ButtonOver(this);" onclick="doBorderStyle('')"
										...
										<div style="border:none;height:10px;width:100%"><%= GetString("NotSet") %></div>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td valign="top" onmouseover="CuteEditor_ColorPicker_ButtonOver(this);" onclick="doBorderStyle('double')"
										style="cursor:default;height:25px;padding:4px;border:white 1px solid;">
										<div style="border-bottom:black double;height:10px;width:100%" title="double"></div>
									</td>
								</tr>
								<tr>
							...
							<table cellpadding="5" cellspacing="0" width="100%" style='table-layout:fixed;background:white'>
								...
								<tr>
									<td valign="top" onmouseover="CuteEditor_ColorPicker_ButtonOver(this);" onclick="doWidth('3px')"
										style="height:25px;padding:1;border:white 1px solid;">
										<table width="100%">
											<tr>
					...
					<td valign="top" style="white-space:nowrap;padding:0 5px 3px 8px;" >
						<table cellpadding="0" cellspacing="0" style="padding-bottom:10px">
							<tr>
								<td><%= GetString("BorderColor") %>:<br />
									<input autocomplete="off" type="text" id="bordercolor" name="bordercolor" size="7" style="WIDTH:57px" />
									<img alt="" id="bordercolor_Preview" src="../Images/colorpicker.gif" class="cursor" style="margin-bottom:-2px" />
								</td>
							</tr>
							<tr>
								<td><%= GetString("ForeColor") %>:<br />
									<input autocomplete="off" type="text" id="inp_color" name="inp_color" size="7" style="WIDTH:57px" > 
									<img alt="" id="inp_color_Preview" src="../Images/colorpicker.gif" class="cursor" style="margin-bottom:-2px" />
								</td>
							</tr>
							<tr>
								<td><%= GetString("Shade") %>:<br />
									<input autocomplete="off" type="text" id="inp_shade" name="inp_shade" size="7" style="WIDTH:57px" > 
								    <img alt="" id="inp_shade_Preview" src="../Images/colorpicker.gif" class="cursor" style="margin-bottom:-2px" />
								</td>
							</tr>
						</table>
					</td>
			...
			<table cellpadding="0" cellspacing="0">
				<tr>
					...
					<td style="padding-bottom:5">
						<table cellpadding="2" cellspacing="0">
							<tr>
								<td colspan="7"><%= GetString("Padding") %>:</td>
							</tr>
							<tr>
								<td><span><%= GetString("Left") %></span>:</td>
				...
				<tr>
					<td colspan="3" style="padding-top:3px;padding-bottom:5px;border-top:lightgrey 1px solid">
						<fieldset><legend><%= GetString("Common") %></legend>
							<table class="normal">
								<tr>
									<td width="80" style="white-space:nowrap" ><%= GetString("Width") %>:</td>
