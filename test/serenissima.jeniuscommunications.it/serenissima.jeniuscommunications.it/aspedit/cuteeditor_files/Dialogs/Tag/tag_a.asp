...
<fieldset style="padding:4px;"><legend><%= GetString("Hyperlink_Information") %></legend>
	<table class="normal">
		<tr>
		...
		<tr>
			...
			<td colspan="3">
				...
				<br />
				<select size="5" name="allanchors" style="width: 255px" id="allanchors" onchange="selectAnchor(this.value);"></select>
			</td>
		</tr>
	</table>									
</fieldset>
