...
<fieldset><legend><%= GetString("Layout") %></legend>
	<table border="0" cellspacing="0" cellpadding="2" class="normal">
		<tr>
			<td style="width:30px"><%= GetString("Position") %>:
			</td>
			...
			<td style="width:30px"><%= GetString("Display") %>:
			</td>
		...
		<tr>
			<td style="width:30px"><%= GetString("Float") %>:
			</td>
			...
			<td style="width:30px"><select style="width:80px" id="sel_clear">
					<option value=""><%= GetString("NotSet") %></option>
...
<fieldset><legend><%= GetString("Size") %></legend>
	<table border="0" cellspacing="0" cellpadding="2" class="normal">
		<tr>
			<td style="width:30px"><%= GetString("Top") %></td>
			<td nowrap><nobr><input type="text" id="tb_top" style="width:40px" />
			...
			<td style="width:30px"><%= GetString("Height") %></td>
			<td nowrap><nobr><input type="text" id="tb_height" style="width:40px" />
		...
		<tr>
			<td style="width:30px"><%= GetString("Left") %></td>
			<td nowrap><nobr><input type="text" id="tb_left" style="width:40px" />
			...
			<td style="width:30px"><%= GetString("Width") %></td>
			<td nowrap><nobr><input type="text" id="tb_width" style="width:40px" />
...
<fieldset><legend><%= GetString("Clipping") %></legend>
	<table border="0" cellspacing="0" cellpadding="2" class="normal">
		<tr>
			<td style="width:30px"><%= GetString("Top") %></td>
			<td><nobr><input type="text" id="tb_cliptop" style="width:40px" />
			...
			<td style="width:30px"><%= GetString("Bottom") %></td>
			<td><nobr><input type="text" id="tb_clipbottom" style="width:40px" />
		...
		<tr>
			<td style="width:30px"><%= GetString("Left") %></td>
			<td><nobr><input type="text" id="tb_clipleft" style="width:40px" />
			...
			<td style="width:30px"><%= GetString("Right") %></td>
			<td><nobr><input type="text" id="tb_clipright" style="width:40px" />
...
<fieldset><legend><%= GetString("Misc") %></legend>
	<div><%= GetString("Overflow") %>:
		...
		&nbsp;
		z-index: <input type="text" style="width:40px" id="tb_zindex" />
	</div>
...
<div id="outer" style="height:80px"><div id="div_demo"><%= GetString("DemoText") %></div></div>
<br />
