...
<fieldset><legend><%= GetString("Table") %></legend>
	...
	<table class="normal" width="98%">
		<tr>
			<td style='width:100px;'><%= GetString("Summary") %> :</td>
			<td>
	...
	<table class="normal" id="CaptionTable">
		<tr>
			...
			<td>
			    <!-- <input id="btn_editcaption" type="button" value="<%= GetString("Insert") %>" />	  -->
			    <!-- <input id="btn_delcaption" type="button" value="<%= GetString("Delete") %>" />		  -->
			     <button id="btn_editcaption"><%= GetString("Insert") %></button>
			     <button id="btn_delcaption"><%= GetString("Insert") %></button>
			</td>
			<td>&nbsp;</td>
			<td><%= GetString("THEAD") %>:</td>
			<td>
				<!--<input id="btn_insthead" type="button" value="<%= GetString("Insert") %>" />	  -->
			...
			<td>
			    <!--<input id="btn_instfoot" type="button" value="<%= GetString("Insert") %>" />	 -->	
...
<fieldset style="margin-top:15px"><legend><%= GetString("Common") %></legend>
	<table class="normal" width="98%">
		<tr>
