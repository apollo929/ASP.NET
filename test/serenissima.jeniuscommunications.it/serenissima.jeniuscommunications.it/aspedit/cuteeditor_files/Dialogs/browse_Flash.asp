    ...
    If DemoMode <> "true" Then
	    ...
	    Select Case action
		    Case "deletefile"  
                ...
                response.redirect("browse_Flash.asp?setting=" & request.querystring("setting") & "&loc=" & request.querystring("loc") & "&MP=" & request.querystring("MP") & "&Theme=" & request.querystring("Theme"))
 		    Case "renamefile"  
