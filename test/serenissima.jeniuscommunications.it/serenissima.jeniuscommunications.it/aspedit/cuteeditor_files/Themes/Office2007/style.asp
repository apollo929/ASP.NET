...
<%=editorid%> {background-color:#D7E3F2!important; border: #7E9DB9 1px solid!important;}
...
<%=editorid%> .CuteEditorDropDown { float: left; border: #7E9DB9 1px solid; margin:1px 1px 1px 1px;padding:0;}
...
<%=editorid%> .CuteEditorFrameContainer {width:100%;height:100%;}
<%=editorid%> .CuteEditorBottomBarContainer {padding:2px;height:1px;overflow-y:visible;}
<%=editorid%> .CuteEditorGroupMenu {margin:1px;float: left;background-image: url(Images/horizontal.background.gif); background-repeat: repeat-x; height:27px; vertical-align:middle;border-top:1px solid #A6B6C5;border:1px solid #A6B6C5;padding:1px;}
<%=editorid%> .CuteEditorGroupMenu span td{ vertical-align:middle}
<%=editorid%> .CuteEditorGroupMenuCell{ float:left;padding-left:3px;}
<%=editorid%> .CuteEditorGroupMenu span td{ vertical-align:middle}
...
<%=editorid%> .CuteEditorButtonActive { margin:0; vertical-align:middle; border:#0a246a 1px solid!important; background-color:#FFDBA3;background-image: url(Images/toolbarbutton.over.gif)}
<%=editorid%> .CuteEditorButtonOver { margin:0;vertical-align:middle;border:#0a246a 1px solid!important; background-color:#FFDBA3;background-image: url(Images/toolbarbutton.over.gif);}
...
<%=editorid%> .tagselector {font:normal 11px Tahoma;margin:0 2px 0 2px;padding:2px;cursor:hand;border: #7E9DB9 1px solid;}
<%=editorid%> .tagselectorOver {font:normal 11px Tahoma;margin:0 2px 0 2px;padding:2px;cursor:hand;border: #7E9DB9 1px solid;background-image: url(Images/toolbarbutton.over.gif);background-repeat: repeat-x; }
