                ...
                <div class="col-md-4">
						...
						<a style="position:relative;top:-80px;" name="odposizione"></a>						
										...
										<div class="single-product">
											<%
											'Query
											querylistcat="Select sottocategoria,categoria From prodotti where categoria='" & Trim(Replace(Request("cat"),"%20"," ")) & "' and fornitore like '%od%' and aboliti='0' group by sottocategoria order by sottocategoria"
											...
											Do While not (tblistcat.eof)%>
												...
												<%
												Response.Write "<a style='font-size:11px;' class='m_scritte'  href='odlista.asp?sotto=" & replace(tblistcat("sottoCategoria")," ","%20") & "&cat=" & replace(tblistcat("categoria")," ","%20") & "#odposizione'>" & ucase(tblistcat("sottocategoria"))  & "</a>"
												%>
												</div>	
												</div>	
							...
							<%
									...
									queryd2="Select * From prodotti where SottoCategoria='" & Trim(Replace(Request("sotto"),"%20"," ")) & "' and Categoria='" & Trim(Replace(Request("cat"),"%20"," ")) &  "' and fornitore like '%od%' and aboliti='0' order by  " & vordine & "  LIMIT " & paginasp & " , " & Divpagine
									...
									<button class="bott_lista_p" onClick="top.location.href='odlista.asp?pagsp=<%=fsp%>&menu=yes&cat=<%=request("cat")%>&sotto=<%=request("sotto")%>#odposizione'"><%=fsp+1%></button>
