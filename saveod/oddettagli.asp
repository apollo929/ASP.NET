                    ...
                    <div class="single-sidebar">
						...
						<%						
							...
							%>
								...
								<a href="oddettagli.asp?cod=<%=tbprodsimili("codice_od")%>"><img  style="max-width:80px;" src='foto.asp?cat=catalogoisp\piccole&img=<%=tbprodsimili("codice_od")%>.jpg' border=0></a>
								<h2><a href="oddettagli.asp?cod=<%=tbprodsimili("codice_od")%>"><b><%=tbprodsimili("codice_od")%></b><br><%=tbprodsimili("descrizione")%></a></h2>
                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade in active" id="home">
												...
												<p>
													...
													<%if lcase(tbprodcatalogo("categoria"))="consumabili" then %>
													<b class="arancione"> <br> <br>LISTA MODELLI PER QUESTA CARTUCCIA </b> : <br> <br>

													<%
													'lista modelli  stampante
													Set tbmodellolista= Server.CreateObject("ADODB.RecordSet")
													sSQLiista="select * From Modello_Disp_Add inner join modello on Modello_Disp_Add.idmodello=modello.id where modello_disp_add.codice_isp like '%" & tbprodcatalogo("codice_od")  & "%' order by modello asc"
													tbmodellolista.open sSQLiista,conn
													i=0
														'response.write("<TABLE border='0' valign='top' cellspacing='0' cellpadding='0' width='100%'><TR><TD valign='top' align='left' >")
														do while not tbmodellolista.eof
														i=i+1
														response.write(ucase(tbmodellolista("modello")) & "<br>")
														if i=4 AND not tbmodellolista.eof then
														'Response.Write "</TD></TR><TR><TD valign=top align=left>"
														i=0
														else
														'Response.Write "</TD><TD valign=top align=left>"
														end if  
														tbmodellolista.movenext
														loop
														tbmodellolista.close
