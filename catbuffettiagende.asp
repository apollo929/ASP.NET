        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
						...
						<h2 class="related-products-title">Agende Buffetti  </h2>
			...
			<%
										...
										'Query
										querydcount="Select count(*) as Tot From prodotti where (descrizione like '%agend%' or descrizione like '%agend%') and fornitore like '%buffetti%'"
										...
										querydp="Select * From prodotti where (descrizione like '%agend%'   or descrizione like '%agend%')  and fornitore like '%buffetti%' order by p1 asc "
